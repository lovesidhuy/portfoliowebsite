...
const projects = [
  {
    ...
    featured: true,
    stack: 'Windows Server 2022 | Active Directory | NPS | RADIUS | EAP-TLS | 802.1X | Wireshark | Terraform | Azure | AD CS',
    bullets: [
      'Built a lab-based WPA3-Enterprise authentication environment with Windows Server NPS, Azure VMs, Active Directory, and AD CS.',
      'Configured 802.1X/EAP-TLS authentication and analyzed RADIUS traffic with Wireshark and Windows Event Logs.',
    ],
    url: 'https://lovesidhuy.github.io/portfoliowebsite/wifi_radius_security_report.pdf',
    linkLabel: 'View report',
  },
  {
    id: 2,
    title: 'IoT Patient Monitoring & Alert System',
    date: 'Apr 2026',
    course: 'IOT',
    featured: true,
    stack: 'Embedded C++ | Arduino | Tinkercad',
    bullets: [
      'Built an embedded C++ prototype simulating temperature, heart rate, and motion data for patient monitoring.',
      'Integrated LCD diagnostics, alert overrides, nurse-call logic, and servo locks; tested nine alarm and fail-safe scenarios.',
    ],
  ...
  },
  {
    ...
    featured: true,
    stack: 'AWS (VPC, EC2, S3, IAM) | Spring Boot | Docker | MongoDB | Python',
    bullets: [
      'Built an AWS lab environment with VPC segmentation, NAT gateways, bastion hosts, and least-privilege IAM for controlled access.',
      'Automated AWS deployment/configuration tasks with Python (Boto3) and packaged frontend/backend services with Docker; tested deployments.',
    ],
